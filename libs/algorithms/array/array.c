...
void forEach_(const int *source, int *dest, const size_t n,
...
int arraySum_(const int *a, const size_t n) {
    int sum = 0;
    for (size_t i = 0; i < n; i++) {
        sum += a[i];
    }
